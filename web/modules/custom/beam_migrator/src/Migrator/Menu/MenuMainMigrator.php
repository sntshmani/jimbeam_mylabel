...
class MenuMainMigrator extends MenuMigrator {

  public function create($varThis) {
    $links = [
      'Our Bourbon' => [
        'link' => 'https://www.jimbeam.com/bourbons',
        'expanded' => TRUE,
        'langcode' => 'en',
        'weight' => 0,
        'below' => [
          'Jim Beam' => [
            'link' => 'https://www.jimbeam.com/bourbons/jim-beam',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 0, 'below' => [],
            'languages' => [
          ...
          'The Flavorful Side' => [
            'link' => 'https://www.jimbeam.com/bourbons#slider-2',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 1, 'below' => [],
            'languages' => [
          ...
          'More Refined Members' => [
            'link' => 'https://www.jimbeam.com/bourbons#slider-1',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 2, 'below' => [],
            'languages' => [
          ...
          'Limited Time Members' => [
            'link' => 'https://www.jimbeam.com/bourbons#slider-3',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 3, 'below' => [],
            'languages' => [
        ...
        'languages' => [
          'de' => ['title' => 'Unser Bourbon', 'link' => 'https://www.jimbeam.com/de/unser-bourbon'],
          'hu' => ['title' => 'Bourbonunk', 'link' => 'https://www.jimbeam.com/bourbons'],
      ...
      'Behind the bourbon' => [
        'link' => 'https://www.jimbeam.com/behind-the-bourbon',
        'expanded' => 'en',
        'langcode' => 'en',
        'weight' => 1,
        'below' => [
          'Beam History' => [
            'link' => 'https://www.jimbeam.com/behind-the-bourbon/our-story',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 0, 'below' => [],
            'languages' => [
          ...
          'Bourbon vs Whiskey' => [
            'link' => 'https://www.jimbeam.com/behind-the-bourbon/bourbon-vs-whiskey',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 1, 'below' => [],
            'languages' => [
          ...
          'Bourbon Process' => [
            'link' => 'https://www.jimbeam.com/behind-the-bourbon/bourbon-process',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 2, 'below' => [],
            'languages' => [
          ...
          'Mixology 101' => [
            'link' => 'https://www.jimbeam.com/behind-the-bourbon/mixology-101',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 3, 'below' => [],
            'languages' => [
          ...
          'Raised Right' => [
            'link' => 'https://www.jimbeam.com/behind-the-bourbon/raised-right',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 4, 'below' => [],
            'languages' => [
        ...
        'languages' => [
          'de' => ['title' => 'Wissenswertes', 'link' => 'https://www.jimbeam.com/de/werdegang-des-bourbon'],
          'hu' => ['title' => 'A burbon mögött', 'link' => 'https://www.jimbeam.com/behind-the-bourbon'],
      ...
      'Visit us' => [
        ...
        'below' => [
          'American Stillhouse' => [
            'link' => 'https://www.jimbeam.com/visit-us/american-stillhouse',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 0, 'below' => [],
            'languages' => [
          ...
          'Urban Stillhouse' => [
            'link' => 'https://www.jimbeam.com/visit-us/urban-stillhouse',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 1, 'below' => [],
            'languages' => [
          ...
          'Events' => [
            'link' => 'https://www.jimbeam.com/visit-us/events',  'expanded' => FALSE, 'langcode' => 'en', 'weight' => 2, 'below' => [],
            'languages' => [
        ...
        'languages' => [
          'de' => ['title' => 'Besuche uns', 'link' => 'https://www.jimbeam.com/de/besuchen-sie-uns'],
          'hu' => ['title' => 'Látogass meg minket', 'link' => 'https://www.jimbeam.com/visit-us'],
    ...
    $varThis->menuLinkMigrator->createStructure($varThis, $links, 'main');
  }
}
