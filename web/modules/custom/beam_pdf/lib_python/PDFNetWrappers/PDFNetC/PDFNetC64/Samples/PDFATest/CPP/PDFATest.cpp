...
{	
	...
	try
	{
		...
		PDFACompliance pdf_a(false, input_path+filename, 0, PDFACompliance::e_Level1B, 0, 10);
	...
	try
	{
		...
		PDFACompliance pdf_a(true, input_path+filename, 0, PDFACompliance::e_Level1B, 0, 10);
		filename = "pdfa.pdf";
		pdf_a.SaveAs(output_path + filename, true);

		// Re-validate the document after the conversion...
		PDFACompliance comp(false, output_path + filename, 0, PDFACompliance::e_Level1B, 0, 10);		
