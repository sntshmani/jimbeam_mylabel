...
public class PDFATest {
    ...
    public static void main(String[] args) {
      	try{ 
            ...
            PDFACompliance pdf_a = new PDFACompliance(false, input_path + filename, null, PDFACompliance.e_Level1B, null, 10);
        ...
        try {
            ...
            PDFACompliance pdf_a = new PDFACompliance(true, input_path + filename, null, PDFACompliance.e_Level1B, null, 10);
            filename = "pdfa.pdf";
            ...
            pdf_a = new PDFACompliance(false, output_path + filename, null, PDFACompliance.e_Level1B, null, 10);
            printResults(pdf_a, filename);
            pdf_a.destroy();
